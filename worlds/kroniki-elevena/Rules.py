...
def set_rules(multiworld: MultiWorld, player: int):
    ...
    connect_regions(multiworld, player, "Menu", "Dom Elevena")
    connect_regions(multiworld, player, "Dom Elevena", "Cyberświat - klasy")
    connect_regions(multiworld, player, "Cyberświat - klasy", "Cyberświat - walka")
    connect_regions(multiworld, player, "Cyberświat - walka", "Cyberświat - partnerzy")
    connect_regions(multiworld, player, "Cyberświat - partnerzy", "Dom Elevena (gra)")
    connect_regions(multiworld, player, "Dom Elevena (gra)", "Pierwsze miasto")
    connect_regions(multiworld, player, "Pierwsze miasto", "Pierwsze miasto Dom1")
    ...
    connect_regions(multiworld, player, "Pierwsze miasto", "Droga połódniowa")
    connect_regions(multiworld, player, "Droga połódniowa", "Droga połódniowa cd.")
    connect_regions(multiworld, player, "Droga połódniowa cd.", "Zakazane bezdroża")
